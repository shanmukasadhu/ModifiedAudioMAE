...
def gen_weight(josn_file, label_file, output_file):
    ...
    label_count = np.zeros(556)

    with open(josn_file, 'r', encoding='utf8')as fp:
        data = json.load(fp)['data']

    for sample in data:
        sample_labels = sample['label'].split(',')
...
if __name__ == '__main__':
    ...
    json_file='/home/ssadhu/EquiAV/arkjobs/training1_7M_updated_with_parents.json'
    label_file='/home/ssadhu/AudioMAE/class_labels_indices556_reformatted.csv'
    output_file='/home/ssadhu/AudioMAE/dataset/audioset/17M_556training_weight.csv'
